...
const byte_t Sys_Rread_map = { 0xc0, };
using Sys_Rwrite = struct { word_t t0; /* vm_string_t */ pointer_t t1; };
const byte_t Sys_Rwrite_map = { 0x40, };
struct Sys_FileIO
{
...
void Sys_aprint(vm_registers_t &, vm_t &);
...
void Sys_bind(vm_registers_t &, vm_t &);
...
void Sys_byte2char(vm_registers_t &, vm_t &);
...
void Sys_char2byte(vm_registers_t &, vm_t &);
...
void Sys_chdir(vm_registers_t &, vm_t &);
...
void Sys_create(vm_registers_t &, vm_t &);
...
void Sys_dial(vm_registers_t &, vm_t &);
...
void Sys_dirread(vm_registers_t &, vm_t &);
...
void Sys_dup(vm_registers_t &, vm_t &);
...
void Sys_export(vm_registers_t &, vm_t &);
...
void Sys_fauth(vm_registers_t &, vm_t &);
...
void Sys_fd2path(vm_registers_t &, vm_t &);
...
void Sys_fildes(vm_registers_t &, vm_t &);
...
void Sys_file2chan(vm_registers_t &, vm_t &);
...
void Sys_fprint(vm_registers_t &, vm_t &);
...
void Sys_fstat(vm_registers_t &, vm_t &);
...
void Sys_fversion(vm_registers_t &, vm_t &);
...
void Sys_fwstat(vm_registers_t &, vm_t &);
...
void Sys_iounit(vm_registers_t &, vm_t &);
...
void Sys_listen(vm_registers_t &, vm_t &);
...
void Sys_millisec(vm_registers_t &, vm_t &);
struct F_Sys_millisec : public vm_frame_base_alloc_t
{
    word_t* ret;
    byte_t temps[12];
};
void Sys_mount(vm_registers_t &, vm_t &);
...
void Sys_open(vm_registers_t &, vm_t &);
...
void Sys_pctl(vm_registers_t &, vm_t &);
...
void Sys_pipe(vm_registers_t &, vm_t &);
...
void Sys_pread(vm_registers_t &, vm_t &);
...
void Sys_print(vm_registers_t &, vm_t &);
...
void Sys_pwrite(vm_registers_t &, vm_t &);
...
void Sys_read(vm_registers_t &, vm_t &);
...
void Sys_readn(vm_registers_t &, vm_t &);
...
void Sys_remove(vm_registers_t &, vm_t &);
...
void Sys_seek(vm_registers_t &, vm_t &);
...
void Sys_sleep(vm_registers_t &, vm_t &);
...
void Sys_sprint(vm_registers_t &, vm_t &);
...
void Sys_stat(vm_registers_t &, vm_t &);
...
void Sys_stream(vm_registers_t &, vm_t &);
...
void Sys_tokenize(vm_registers_t &, vm_t &);
...
void Sys_unmount(vm_registers_t &, vm_t &);
...
void Sys_utfbytes(vm_registers_t &, vm_t &);
...
void Sys_werrstr(vm_registers_t &, vm_t &);
...
void Sys_write(vm_registers_t &, vm_t &);
...
void Sys_wstat(vm_registers_t &, vm_t &);
...
const word_t Sys_QTFILE = 0;
const word_t Sys_ATOMICIO = 0x2000;
const word_t Sys_SEEKSTART = 0;
